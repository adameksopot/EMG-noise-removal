...
#generate noise
gaussian_noise = np.random.normal(0, 0.1, 2000) #0.01
...
#this is for the Y and denoised - here the noise is from the subtraction
print("SNR for Savitzky-Golay : ",signaltonoiseratio(0,y_pred2))#count noise from SGfilter
...
#this is for the Y and denoised - here the noise is from the subtraction
print("\nSNR for KNN Regressor : ",signaltonoiseratio(0,y_pred3)) #count noise from KNN
print("MSE for KNN Regressor : ", meansquareerror(Y,y_pred3))
print("Cross correlation for KNN Regressor : ", crosscorelation(Y,y_pred3))
#this is for YwithNoise and denoised - here the noise is gaussian noise
print("\nSNR for KNN Regressor : ",signaltonoiseratio(0,y_pred3)) 
print("MSE for KNN Regressor : ", meansquareerror(Y,y_pred3))
print("Cross correlation for KNN Regressor : ", crosscorelation(Y,y_pred3))
...
#this is for the Y and denoised - here the noise is from the subtraction
print("\nSNR for wavlet transform : ",signaltonoiseratio( noiseWT,Y_denoised_WT))
...
#this is for YwithNoise and denoised - here the noise is gaussian noise
print("\nSNR for wavlet transform : ",signaltonoiseratio( gaussian_noise,Y_denoised2_WT))
